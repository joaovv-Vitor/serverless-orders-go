.PHONY: test validate build local-invoke local-invoke-stock local-invoke-notification local-api clean build-CreateOrderFunction build-ProcessStockFunction build-SendNotificationFunction
